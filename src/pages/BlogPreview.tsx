...
const BlogPreview = () => {
  ...
  useEffect(() => {
    const draft = localStorage.getItem('blog_preview_draft');
    if (draft) {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-primary/10 py-2 text-center text-sm font-medium text-primary sticky top-16 z-40 backdrop-blur-sm">
        Preview Mode - This is how your post will look once published
      </div>
